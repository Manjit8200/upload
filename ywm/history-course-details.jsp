...
<script	src="<%=request.getContextPath()%>/resources/admin/js/controller/historycourseDetails.js"></script>

</head>

<body ng-app="ywm" ng-controller="HistorycourseDetailCtrl" ng-init="getCourseDetail(<%= request.getParameter("courseId") %>)">
			...
			<div class="row blog-page">
				...
				<div class="col-md-3 sidebar left-sidebar">
					...
					<div class="widget widget-categories">
						...
						<p>Rs. {{courseDetail.courseFee}} ({{courseDetail.courceFeeValidity}})</p>
